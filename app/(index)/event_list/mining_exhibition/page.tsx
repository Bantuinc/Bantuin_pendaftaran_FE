          ...
          <div className="flex lg:flex-row flex-col gap-12 px-9 py-12 md:w-[80vw] w-full">
            ...
            <div className={`text-left flex flex-col gap-3 md:max-w-[50%]`}>
              ...
              <p className="font-bold text-slate-50 md:text-lg text-sm">
                an event where cutting-edge technologies and innovations take
                center stage. Experience the excitement of underground mining
                simulations, offering a realistic glimpse into the challenges
                and thrills of mining operations. The venue will also showcase a
                gallery of posters, each a masterpiece from the ISMC XIV poster
                competition, showcasing the creative prowess of participants.
              </p>
        ...
        <div className="py-8 px-16 flex flex-col items-center gap-12 ring-2 md:max-w-[80vw] ring-slate-200/70 shadow-xl shadow-slate-900/30 rounded-[32px] bg-gradient-to-tr from-[#ccc0] to-[#ccca] backdrop-blur-[12px] text-center">
          ...
          <div className="bg-slate-800 p-6 rounded-xl text-white">
            <div className="flex flex-col items-center gap-3 text-sm">
              <Calendar />
              Monday - Saturday, 19th - 24th February 2024
              <MapPin />
              Soemardja Gallery, ITB
            </div>
          </div>
        </div>
      </section>
...
export default MiningExhibition;
