    ...
    return (
        <>
            <Link href={`./${teamId}/add`}>
                <div
                    className="min-h-[20rem] group bg-[#296875]/30  py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-[#296875]/40 hover:smooth-hover">
...
export function memberCard({teamMemberId,teamId,name,image} :memberCardProps){
    return(
        <>
            <Link href={`${teamId}/${teamMemberId}`}>
                <div
                    className="min-h-[20rem] relative group bg-[#296875] py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-[#296875]/80 hover:smooth-hover">
                    <div className=" ">
                        ...
                        <p className="absolute top-2 text-white/20 inline-flex items-center text-xs">Waiting <span
                            className="ml-2 w-2 h-2 block bg-yellow-500 rounded-full group-hover:animate-pulse"/>
                        </p>
                    </div>
                </div>
            </Link>
