        ...
        <>
            ...
            <div className="bg-[#296875] max-sm:mb-10 md:mb-10 lg:mr-10 lg:mb-0 px-2 lg:px-4 py-2 lg:py-10 sm:rounded-xl flex lg:flex-col justify-between">
                <nav className="flex items-center flex-row space-x-2 lg:space-x-0 lg:flex-col lg:space-y-2">
                    <a className={(active==="home"?activeClass:nonActiveClass)+" p-4 inline-flex justify-center rounded-md hover:bg-gray-800 hover:text-white smooth-hover"}
                       href="./dashboard">
                    ...
                    <a className={(active==="group"?activeClass:nonActiveClass)+" p-4 inline-flex justify-center rounded-md hover:bg-gray-800 hover:text-white smooth-hover"}
                       href="./groups">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6"
                             viewBox="0 0 20 20" fill="currentColor">
                            <path
                    ...
                    <a className={(active==="payment"?activeClass:nonActiveClass)+" p-4 inline-flex justify-center rounded-md hover:bg-gray-800 hover:text-white smooth-hover"}
                       href="./payment">
